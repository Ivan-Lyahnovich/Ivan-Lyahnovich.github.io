/* Перемещен некоторый функционал в Display.prototype.
Был создал класс Display.TileSheet обрабатывающий изображения блоки и  их размеры.
Был убран drawRectangle и замен функцией drawPlayer. */
...
const Display = function(canvas) {
  ...
  /* Зарисовывает карту мира в буфер */
