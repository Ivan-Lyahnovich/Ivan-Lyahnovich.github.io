/* Изменено округление метода в функции drawPlayer из Math.floor в Math.round, для лучшего представления расположения игрока. */
...
const Display = function(canvas) {
  ...
  /* Вносит карту в буфер */
  this.drawMap = function(map, columns) {

    for (let index = map.length - 1; index > -1; -- index) {

      let value = map[index]; // Больше не вычитает 1.
